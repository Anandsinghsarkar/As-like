...
import { 
  MessageCircle, UserPlus, Settings, User, 
  Send, ArrowLeft, Check, CheckCheck, LogOut, Trash2, Edit2, Camera,
...
// Kept local so the Android package does not depend on a third-party emoji API.
